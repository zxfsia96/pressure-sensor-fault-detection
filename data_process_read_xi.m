...
close all;
% 读取Excel文件  
excel_file = 'E:\故障诊断\数据集处理\1021\算法\PYTHON\12\output_xi.xlsx';  
% data = readtable(excel_file);  
% filename_output_cu='E:\故障诊断\数据集处理\1021\数据处理结果\20240119_trend_feature\feature_xi.xlsx'; 
 filename_output_cu='E:\故障诊断\feature_xi_m.xlsx'; 
num=12;
A = cell(num,1);
data_table=[];
for m=1:num
